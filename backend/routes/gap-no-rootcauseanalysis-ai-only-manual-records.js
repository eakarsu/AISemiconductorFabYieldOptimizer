...
const FEATURE_SLUG = 'no-rootcauseanalysis-ai-only-manual-records';
const FEATURE_TITLE = 'No /root-cause-analysis AI (only manual records)';
const PROJECT = 'AISemiconductorFabYieldOptimizer';
