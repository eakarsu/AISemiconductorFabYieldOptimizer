...
export default function GapNoRootcauseanalysisAiOnlyManualRecords() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rootcauseanalysis-ai-only-manual-records', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No /root-cause-analysis AI (only manual records)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISemiconductorFabYieldOptimizer - Gap feature</p>
