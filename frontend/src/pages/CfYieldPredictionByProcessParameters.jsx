...
export default function CfYieldPredictionByProcessParameters() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-yield-prediction-by-process-parameters', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Yield prediction by process parameters</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISemiconductorFabYieldOptimizer - Custom feature</p>
